...
abstract interface class CurrencyDataCommon {
  ...
  /// Bahamian Dollar
  static CurrencyData get bsd =>
      CurrencyData.create('BSD', 2, country: 'Bahamas', unit: 'Dollar', name: 'Bahamian Dollar');
  ...
  /// Barbadian Dollar
  static CurrencyData get bbd =>
      CurrencyData.create('BBD', 2, country: 'Barbados', unit: 'Dollar', name: 'Barbadian Dollar');
  ...
  /// Bermudian Dollar
  static CurrencyData get bmd =>
      CurrencyData.create('BMD', 2, country: 'Bermuda', unit: 'Dollar', name: 'Bermudian Dollar');
  ...
  /// Brunei Dollar
  static CurrencyData get bnd =>
      CurrencyData.create('BND', 2, country: 'Brunei', unit: 'Dollar', name: 'Brunei Dollar');
  ...
  /// Canadian Dollar
  static CurrencyData get cad =>
      CurrencyData.create('CAD', 2, country: 'Canada', unit: 'Dollar', name: 'Canadian Dollar');
  ...
  /// Cuban Peso
  static CurrencyData get cup =>
      CurrencyData.create('CUP', 2, country: 'Cuba', unit: 'Peso', name: 'Cuban Peso');
  ...
  /// Fijian Dollar
  static CurrencyData get fjd =>
      CurrencyData.create('FJD', 2, country: 'Fiji', unit: 'Dollar', name: 'Fijian Dollar');
  ...
  /// Guyanese Dollar
  static CurrencyData get gyd =>
      CurrencyData.create('GYD', 2, country: 'Guyana', unit: 'Dollar', name: 'Guyanese Dollar');
  ...
  /// Hong Kong Dollar
  static CurrencyData get hkd =>
      CurrencyData.create('HKD', 2, country: 'Hong Kong', unit: 'Dollar', name: 'Hong Kong Dollar');
  ...
  /// Jamaican Dollar
  static CurrencyData get jmd =>
      CurrencyData.create('JMD', 2, country: 'Jamaica', unit: 'Dollar', name: 'Jamaican Dollar');
  ...
  /// Lao Kip
  static CurrencyData get lak =>
      CurrencyData.create('LAK', 2, symbol: '₭', country: 'Laos', unit: 'Kip', name: 'Lao Kip');
  ...
  /// Liberian Dollar
  static CurrencyData get lrd =>
      CurrencyData.create('LRD', 2, country: 'Liberia', unit: 'Dollar', name: 'Liberian Dollar');
  ...
  /// Mexican Peso
  static CurrencyData get mxn =>
      CurrencyData.create('MXN', 2, country: 'Mexican', unit: 'Peso', name: 'Mexican Peso');
  ...
  /// Namibian Dollar
  static CurrencyData get nad =>
      CurrencyData.create('NAD', 2, country: 'Namibia', unit: 'Dollar', name: 'Namibian Dollar');
  ...
  /// Singapore Dollar
  static CurrencyData get sgd =>
      CurrencyData.create('SGD', 2, country: 'Singapore', unit: 'Dollar', name: 'Singapore Dollar');
  ...
  /// Surinamese Dollar
  static CurrencyData get srd =>
      CurrencyData.create('SRD', 2, country: 'Suriname', unit: 'Dollar', name: 'Surinamese Dollar');
