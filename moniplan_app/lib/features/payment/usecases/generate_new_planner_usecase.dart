...
class GenerateNewPlannerUseCase {
  ...
  GenerateNewPlannerUseCaseResult run() {
    ...
    if (payments.isEmpty) {
      ...
      return GenerateNewPlannerUseCaseResult(originalPayments: payments, planner: emptyPlanner);
    }
    ...
    return GenerateNewPlannerUseCaseResult(originalPayments: payments, planner: resultPlanner);
  }
}
...
class GenerateNewPlannerUseCaseResult {
  ...
  const GenerateNewPlannerUseCaseResult({required this.originalPayments, required this.planner});
}
