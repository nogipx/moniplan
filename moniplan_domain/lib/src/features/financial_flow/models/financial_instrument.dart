...
enum FinancialInstrumentType {
  ...
  bool get isExpense =>
      this == regularExpense || this == oneTimeExpense || this == creditPayment;
  bool get isCredit => this == creditPayment;
  bool get isRegular =>
      this == regularIncome || this == regularExpense || this == creditPayment;
}
...
class FinancialInstrument with _$FinancialInstrument {
  ...
  const factory FinancialInstrument({
    ...
    @Default(DateTimeRepeat.noRepeat)
    @DateTimeRepeatConverter()
    DateTimeRepeat repeat,
