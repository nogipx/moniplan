...
class PaymentMapper implements IMapper<Payment, PaymentComposedDaoIsar> {
  @override
  Payment toDomain(PaymentComposedDaoIsar data) {
    final id = data.id;
  ...
  @override
  PaymentComposedDaoIsar toDto(Payment data) {
    return PaymentComposedDaoIsar(
      id: data.id,
