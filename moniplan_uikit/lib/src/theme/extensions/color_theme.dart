...
extension ColorSchemeLerp on ColorScheme {
  ColorScheme lerp(ColorScheme? b, double t) {
    return ColorScheme(
      ...
      background: Color.lerp(background, b?.background, t) ?? background,
      onBackground: Color.lerp(onBackground, b?.onBackground, t) ?? onBackground,
      surface: Color.lerp(surface, b?.surface, t) ?? surface,
      onSurface: Color.lerp(onSurface, b?.onSurface, t) ?? onSurface,
      surfaceVariant: Color.lerp(surfaceVariant, b?.surfaceVariant, t) ?? surfaceVariant,
