...
class AppAppBarTheme {
  ...
  AppAppBarTheme.get(ThemeStyle themeStyle)
      : backgroundColor = Colors.transparent,
        ...
        toolbarTextStyle = AppTextTheme.get(themeStyle).displayLarge,
        titleTextStyle = AppTextTheme.get(themeStyle).displayLarge,
